...
const MarkupModal = (props) => {
    const { markupModalOpen } = props;
    
    const saveMarkupImage = () => {
                    ...
                    <div className={styles[`markup-container`]}>
                            ...
                            <div className={styles[`color-picker-container`]}>
                                <div className={`btn-group`} role="group">
                                    <button type="button" className={`${styles[`markup-tool-container`]} btn btn-light`}>
                                        <svg className={styles[`color-picker-toggle`]} aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle" class="svg-inline--fa fa-circle fa-w-16 ImageMarkup_color-picker-toggle__LnQLN" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" color="rgba(0,95,252,1)">
                        ...
                        <div className={styles[`markup-control-container`]}>
                            ...
                            <div className={styles[`close-container`]}>
                                <button type="button" className={`${styles[`markup-save-btn`]} btn btn-primary`} onClick={saveMarkupImage}>
                                    저장
                                </button>
                            </div>
                        </div>
