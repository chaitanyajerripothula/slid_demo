...
class Paragraph {
  ...
  onInput(e) {
    ...
    if (textContent === "```") {
      ...
      // convert to unordered blockList block.

      const blockIndex = this.api.blocks.getCurrentBlockIndex();
      const value = textContent === "- " ? "" : textContent.split("- ").splice(1, 1).join("- ");
      ...
      // convert to ordered blockList block.

      const blockIndex = this.api.blocks.getCurrentBlockIndex();
      const value = textContent === "1. " ? "" : textContent.split("1. ").splice(1, 1).join("1. ");
